                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('products.index') }}"
                            class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2">Products</a>
                    </div>
                </li>
            ...
            <div class="md:flex">
                ...
                <div class="md:w-1/2 p-6">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <span class="ml-2 text-gray-600">{{ number_format($averageRatings['overall'], 1) }}
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <div class="custom-number-input h-10 w-32">
                                    <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                                        <button type="button"
                                            class="bg-gray-200 text-gray-600 hover:text-gray-700 hover:bg-gray-300 h-full w-20 rounded-l cursor-pointer outline-none"
                                        ...
                                        <input type="number" name="quantity" id="quantity"
                                            ...
                                            min="1" max="{{ $product->inventory_count }}" value="1">
                                        <button type="button"
            ...
            <div class="md:flex">
                <div class="md:w-1/3 mb-6 md:mb-0">
                    <div class="flex items-center mb-2">
                        <div class="text-5xl font-bold text-gray-900">{{ number_format($averageRatings['overall'], 1) }}
                        </div>
                        <div class="ml-4">
                            <div class="flex text-yellow-400">
                                @for ($i = 1; $i <= 5; $i++)
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2.5 ml-2">
                                <div class="bg-blue-600 h-2.5 rounded-full"
                                    style="width: {{ $averageRatings['quality'] * 20 }}%"></div>
                            </div>
                            <span
                                class="ml-2 text-sm font-medium text-gray-700">{{ number_format($averageRatings['quality'], 1) }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="text-sm font-medium w-20">Value</span>
                            <div class="w-full bg-gray-200 rounded-full h-2.5 ml-2">
                                <div class="bg-blue-600 h-2.5 rounded-full"
                                    style="width: {{ $averageRatings['value'] * 20 }}%"></div>
                            </div>
                            <span
                                class="ml-2 text-sm font-medium text-gray-700">{{ number_format($averageRatings['value'], 1) }}</span>
                        </div>
                        <div class="flex items-center">
                            <span class="text-sm font-medium w-20">Price</span>
                            <div class="w-full bg-gray-200 rounded-full h-2.5 ml-2">
                                <div class="bg-blue-600 h-2.5 rounded-full"
                                    style="width: {{ $averageRatings['price'] * 20 }}%"></div>
                            </div>
                            <span
                                class="ml-2 text-sm font-medium text-gray-700">{{ number_format($averageRatings['price'], 1) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mb-8 border-b pb-8">
                    ...
                    <form action="{{ route('reviews.store') }}" method="POST">
                            ...
                            <div class="flex">
                                @for ($i = 1; $i <= 5; $i++)
                                    <label class="mr-2 cursor-pointer">
                                        ...
                                        <svg class="h-8 w-8 text-gray-300 peer-checked:text-yellow-400" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                                                d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z">
                                            </path>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                <label for="quality_rating" class="block text-gray-700 text-sm font-bold mb-2">Quality
                                    Rating</label>
                            ...
                            <div>
                                <label for="value_rating" class="block text-gray-700 text-sm font-bold mb-2">Value
                                    Rating</label>
                            ...
                            <div>
                                <label for="price_rating" class="block text-gray-700 text-sm font-bold mb-2">Price
                                    Rating</label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="comments" name="comments" rows="4"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Share your experience with this product..." require></textarea>
                        </div>
            ...
            @else
                <div class="bg-gray-50 p-4 rounded-lg mb-8">
                    <p class="text-gray-700">Please <a href="{{ route('login') }}"
                            class="text-blue-600 hover:text-blue-800 font-medium">login</a> to leave a review.</p>
                </div>
            @endauth
                    ...
                    @foreach ($reviews as $review)
                        <div class="border-b pb-6 last:border-b-0">
                            <div class="flex justify-between items-start">
                                <div>
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="ml-2 text-lg font-semibold text-gray-900">{{ $review->customer->name }}
                                        </h3>
                                        @if ($review->isVerifiedPurchase())
                                            <span
                                                class="ml-2 bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">Verified
                                                Purchase</span>
                                        @endif
                                    </div>
                            ...
                            <div class="mt-4 flex items-center">
                                ...
                                <button
                                    class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-1 px-3 rounded-full text-xs mr-2 vote-helpful"
                                    data-review-id="{{ $review->id }}">
                                    Yes ({{ $review->helpful_votes }})
                                </button>
                                <button
                                    class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-1 px-3 rounded-full text-xs vote-unhelpful"
                                    data-review-id="{{ $review->id }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                @for ($i = 0; $i < 4; $i++)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transition transform hover:scale-105">
                        <a href="#">
                            <img src="https://via.placeholder.com/600x400?text=No+Image" alt="Related Product"
                                class="w-full h-48 object-cover">
                        </a>
                        <div class="p-4">
                            <a href="#" class="text-lg font-medium text-gray-900 hover:text-blue-600">Related
                                Product {{ $i + 1 }}</a>
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <button class="bg-blue-600 text-white px-3 py-1 rounded-md hover:bg-blue-700">Add to
                                    Cart</button>
                            </div>
                        </div>
                    </div>
